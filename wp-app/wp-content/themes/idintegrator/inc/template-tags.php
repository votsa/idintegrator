...
if ( ! function_exists( 'Id_integrator_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function Id_integrator_posted_on() {
...
if ( ! function_exists( 'Id_integrator_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function Id_integrator_entry_footer() {
...
if ( ! function_exists( 'Id_integrator_post_thumbnail' ) ) :
/**
 ...
 */
function Id_integrator_post_thumbnail() {
