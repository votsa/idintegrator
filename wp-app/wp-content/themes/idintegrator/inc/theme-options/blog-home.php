...
Id_integrator_Kirki::add_section( 'blog_home', array(
    'title'          => esc_html__( 'Blog Homepage', 'idintegrator' ),
    'panel'          => 'theme_options',
...
Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
	...
	'section'  => 'blog_home',
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title first-region-title">' . esc_html__( 'Cover Section', 'idintegrator' ) . '</h2>',
) );

Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
	'settings' => 'blog_display_cover_section',
	'label'    => esc_html__( 'Display Cover Section', 'idintegrator' ),
	'section'  => 'blog_home',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
	...
	'label'             => esc_html__( 'Cover Lead Text', 'idintegrator' ),
	'section'           => 'blog_home',
	'type'              => 'text',
) );
...
Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
	...
	'section'  => 'blog_home',
	'type'     => 'custom',
    'default'  => '<h2 class="wp-bp-region-title">' . esc_html__( 'Featured Posts Slider', 'idintegrator' ) . '</h2>',
) );

Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
	'settings' => 'blog_display_posts_slider',
	'label'    => esc_html__( 'Display Posts Slider', 'idintegrator' ),
	'section'  => 'blog_home',
	'type'     => 'checkbox',
    'default'  => 1,
) );
...
Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
	...
	'label'    => esc_html__( 'Number of Posts In Slider', 'idintegrator' ),
	'section'  => 'blog_home',
	'type'     => 'number',
    'default'  => '5',
    'choices'  => array(
...
if( class_exists( 'Kirki_Helper' ) ) {
    Id_integrator_Kirki::add_field( 'Id_integrator_theme', array(
    	...
    	'label'       => esc_html__( 'Select Posts', 'idintegrator' ),
    	'section'     => 'blog_home',
    	'type'        => 'select',
        'multiple'    => 10,
