							...
							<div class="card-body">
								<section class="error-404 not-found">
									<header class="page-header">
										<h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'id-integrator' ); ?></h1>
									</header><!-- .page-header -->
									...
									<div class="page-content">
										...
										<div class="widget widget_categories">
											<h5 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'id-integrator' ); ?></h5>
											<ul>
											<?php
